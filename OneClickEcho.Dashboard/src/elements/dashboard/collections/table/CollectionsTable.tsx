        ...
        () => [
            columnHelper.accessor("collectionName", {
                ...
                cell: ({ row }: { row: { getVisibleCells: () => Cell<CollectionDto, any>[]; original: CollectionDto } }) => (
                    <Link
                        href={withLocale(`/collections/${row.original.leadCollectionId}`)}
            ...
            columnHelper.display({
                ...
                cell: ({ row }) => (
                    <DataTableRowActions
                        row={row}
                        onEdit={() => {
                            router.push(withLocale(`/collections/${row.original.leadCollectionId}`));
                        }}
                    />
                )
            })
        ],
        [columnHelper, dtf, router, t, withLocale]
    );
