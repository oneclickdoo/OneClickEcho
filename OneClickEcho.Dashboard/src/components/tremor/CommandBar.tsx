        ...
        <Popover.Root open={open} onOpenChange={onOpenChange} defaultOpen={defaultOpen}>
            ...
            <Popover.Portal>
                <Popover.Content
                    ...
                    className={cx("z-50", "data-[state=closed]:animate-hide", "data-[side=top]:animate-slideUpAndFade")}
                >
                    {children}
                </Popover.Content>
            </Popover.Portal>
...
// Backward-compatible alias (keeps old misspelling)
const CommandBarSeperator = CommandBarSeparator;
