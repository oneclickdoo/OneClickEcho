...
type PopoverContentProps = React.ComponentPropsWithoutRef<typeof PopoverPrimitives.Content>;
                ...
                <PopoverPrimitives.Content
                    ...
                    onWheel={(event) => {
                        ...
                        event.currentTarget.dispatchEvent(
                            new KeyboardEvent("keydown", { key: isScrollingDown ? "ArrowDown" : "ArrowUp" })
                        );
                    }}
                    {...props}
                />
