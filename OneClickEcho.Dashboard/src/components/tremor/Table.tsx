...
const TablePaginationButton = ({
    ...
    return (
        <button
            type="button"
            className={cx(
                "group rounded-md p-1.5 ring-1 ring-gray-300 dark:ring-gray-800",
                "hover:bg-gray-50 hover:dark:bg-gray-900",
                "disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:bg-transparent disabled:hover:dark:bg-transparent",
            )}
            onClick={onClick}
            disabled={disabled}
        >
