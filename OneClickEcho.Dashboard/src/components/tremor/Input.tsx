...
const Input = React.forwardRef<HTMLInputElement, InputProps>((allProps, forwardedRef) => {
    // ✅ Ključ: da li je value prop uopšte prosleđen (čak i ako je undefined)
    ...
    // Ako parent šalje value prop, tretiraj kao controlled od starta:
    // null/undefined -> ""
    const normalizedValue =
        hasValueProp
            ? ((allProps.value ?? "") as any)
            : undefined;
