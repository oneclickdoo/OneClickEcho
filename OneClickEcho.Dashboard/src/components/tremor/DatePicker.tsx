...
const TimeInput = React.forwardRef<HTMLDivElement, TimeInputProps>(({ hourCycle, ...props }: TimeInputProps, ref) => {
    ...
    // FIX: correct SSR-safe window check
...
const formatDate = (date: Date, locale: Locale, includeTime?: boolean): string => {
    ...
    if (includeTime) {
        dateString = usesAmPm ? format(date, "dd MMM, yyyy h:mm a", { locale }) : format(date, "dd MMM, yyyy HH:mm", { locale });
    } else {
...
type Translations = {
    ...
    endDateTime?: string;
    selectPreset?: (label: string) => string;
    selectDate?: string;
...
const SingleDatePicker = ({
    ...
    const resolvedPlaceholder = placeholder ?? translations?.selectDate ?? "Select date";
                        ...
                        <div>
                            ...
                            {showTimePicker && (
                                <div className="border-t border-gray-200 p-3 dark:border-gray-800">
                                    <TimeInput
                                        aria-label={translations?.time ?? "Time"}
                                        // @ts-ignore
...
const RangeDatePicker = ({
    ...
    const onCancel = () => {
        ...
        setStartTime(initialRange?.from ? new Time(initialRange.from.getHours(), initialRange.from.getMinutes()) : new Time(0, 0));
    ...
    const resolvedPlaceholder = placeholder ?? translations?.selectDateRange ?? "Select date range";
                        ...
                        <div>
                                ...
                                <div className="flex items-center justify-evenly gap-x-3 border-t border-gray-200 p-3 dark:border-gray-800">
                                    <div className="flex flex-1 items-center gap-x-2">
                                        ...
                                        <TimeInput
                                            ...
                                            aria-label={translations?.startDateTime ?? "Start date time"}
                                    ...
                                    <div className="flex flex-1 items-center gap-x-2">
                                        ...
                                        <TimeInput
                                            ...
                                            aria-label={translations?.endDateTime ?? "End date time"}
                                            isDisabled={!range?.to}
                                            isRequired={props.required}
                                        />
                                    </div>
                            ...
                            <div className="border-t border-gray-200 p-3 sm:flex sm:items-center sm:justify-between dark:border-gray-800">
                                ...
                                <div className="mt-2 flex items-center gap-x-2 sm:mt-0">
                                    ...
                                    <Button variant="primary" className="h-8 w-full bg-indigo-600 sm:w-fit" type="button" onClick={onApply}>
                                        {translations?.apply ?? "Apply"}
                                    </Button>
                                </div>
                            </div>
        ...
        presets.forEach((preset) => {
            ...
            if ("dateRange" in preset) {
                ...
                if (fromMonth) {
                    ...
                    if (presetMonth !== undefined && presetMonth < fromMonth.getMonth()) {
                        throw new Error(
                ...
                if (toMonth) {
                    ...
                    if (presetMonth !== undefined && presetMonth > toMonth.getMonth()) {
                        throw new Error(
                ...
                if (fromDay) {
                    ...
                    if (presetDay !== undefined && presetDay < fromDay.getDate()) {
                        throw new Error(
                ...
                if (toDay) {
                    ...
                    if (presetDay !== undefined && presetDay > toDay.getDate()) {
                        throw new Error(
