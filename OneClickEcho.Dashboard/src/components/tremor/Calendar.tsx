...
const Calendar = ({
    ...
    classNames,
    ...props
}: CalendarProps & { enableYearNavigation?: boolean; labels?: Partial<CalendarLabels> }) => {
                ...
                Caption: ({ ...captionProps }) => {
                    ...
                    return (
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-1">
                                {enableYearNavigation && !hidePreviousButton && (
                                    <NavigationButton
                                        ...
                                        aria-label={resolvedLabels.previousYear}
                            ...
                            >
                                {format(captionProps.displayMonth, "LLLL yyyy", { locale })}
                            </div>
                            ...
                            <div className="flex items-center gap-1">
                                ...
                                {enableYearNavigation && !hideNextButton && (
                                    <NavigationButton
                                        ...
                                        aria-label={resolvedLabels.nextYear}
